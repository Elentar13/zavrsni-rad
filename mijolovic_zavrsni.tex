...
\begin{document}
    ...
    \chapter{Uvod}
        ...
        \section{Vrste signala i sustava}
        ...
        %Praktički svih 10 knjiga koje imam sa FER2... potrebna brza analiza uvoda
            ...
            U vremenski \textit{kontinuiranim signalima} vremenska konstanta $t$ je kontinuirana i njezina domena, što rezultira i konrinuiranim vrijednostima slike promatrane funkcije. Navedeno se može grafički predočiti pomoću glatke neprekidne linije kao što je prikazano na Slici \ref{fig:M31} koja prikazuje vremenski kontinuirani signal $x(t)=sin(2\pi t)$. Za razliku od vremenski kontinuiranih signala, u vremenski \textit{diskretnim signalima} vremenska konstanta je definirana u točno određenim -- diskretnim -- vremenima. Posljedično, vrijednosti slike promatrane funkcije biti poznate samo u prethodno definiranim diskretnim vremenima. Primjer vremenski diskretnog signala $x[n]=sin(2\pi n)$ grafički je prikazan na Slici \ref{fig:M32}.
            ...
            \begin{figure}[H]
                ...
                \begin{minipage}[b] {.4\linewidth}
                    ...
                    \begin{tikzpicture}
                        ...
                        \end{axis} 
                    \end{tikzpicture}
                    \subcaption{Vremenski kontinuirani signal}
                    \label{fig:M31}
                \end{minipage}
                \qquad\qquad
                \begin{minipage}[b] {.4\linewidth}
                    ...
                    \begin{tikzpicture}
                        ...
                        \end{axis} 
                    \end{tikzpicture}
                    \subcaption{Vremenski diskretni signal}      
                    \label{fig:M32}
                \end{minipage}
                \caption{Prikaz vremenski kontinuiranoga i vremenski diskretnoga signala funkcije $sin(2 \pi t)$}
                \label{fig:M3}    
            \end{figure}

            
            Primjer vremenski kontinuiranih signala su brzina, pozicija vozila, govor, zvuk iz audio sustava i sl.; dok su primjeri vremenski diskretnih signala mjesečna vrijednost dionica, demografski pokazatelji poput nataliteta i sl. Kao što smo već prethodno ustanovili, vremenski diskretni signali mogu reprezentirati bilo koje promatrani fenomen čije se vrijednosti mogu dobiti za točno određeni trenutak -- što nas dovodi do zaključka o postojanju mogućnosti prikazivanja vremenski kontinuiranih signala pomoću vremenski diskretnih signala. To je moguće sukcesivnim \textit{uzorkovanjem} vremenski kontinuiranoga signala (eng. \textit{sampling}), čime dolazimo do diskretnih vrijednosti signala. Rezolucijom uzorkovanog signala moguće je upravljati pomoću podešavanja frekvencije uzorkovanja (eng. \textit{sampling rate}). Tako je prethodno navedeni diskretni signal prikazan na Slici \ref{fig:M32} načinjen uzorkovanjem kontinuiranoga signala na Slici \ref{fig:M31} temeljem 21 uzorka.  Navedena klasa signala vrlo je korisna prilikom digitalne obrade signala. Uzmemo li u obzir prethodno spomenute prednosti brzine računalnog procesuiranja podatka, ali i postojeća ograničenja računalnih sustava radnom memorijom, procesorskim performansama, te digitaliziranom obradom podataka; važnost vremenski diskretnih signala i uzorkovanja je neminovna -- što je dokazano širokom i ekonomičnom integracijom funkcionalnosti obrade signala u različita tehnološka i ina rješenja (npr. mogućnost mobilnih uređaja da prepoznaju glasovne naredbe).
            ...
            \subsection{Osnovna svojstva}

            \textbf{(Napraviti uvod o stručnoj terminologiji (kauzalni, nekauzalni signali), a koji će biti od koristi poslije... manje matematičke stvari, više stvari vezane uz vremensku konstantu)}
        ...
        \section{Metodologije prognoziranja}%potrebno je dodatno poraditi na naslovima i podnaslovima jer će se dalje spominjati random varijale i sl., pa je potrebno provjeriti medotologije koje su prikazane u knjizi
            ...
            \textbf{(Navesti metode prognoziranja (subjective, model-based) i podjelu modela na kauzalne i nekauzalne modele)}
