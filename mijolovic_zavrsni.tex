...
\begin{document}
    ...
    \chapter{Uvod}
        ...
        \begin{center}
        \begin{tikzpicture}
            \draw[ultra thin, color=lightgray] (12,3) grid (0,0);
            \draw[-] (0,0) -- (12,0) node[below=0.6cm] {$t/\textit{\textdegree C}$};
            %\node[anchor=0.6cm, align=center] {$\text{tekst}$};
            \node[anchor=north] at (0,0) {$-20$};
            \node[anchor=north] at (1,0) {$-15$};
            \node[anchor=north] at (2,0) {$-10$};
            \node[anchor=north] at (3,0) {$-5$};
            \node[anchor=north] at (4,0) {$0$};
            \node[anchor=north] at (5,0) {$5$};
            \node[anchor=north] at (6,0) {$10$};
            \node[anchor=north] at (7,0) {$15$};
            \node[anchor=north] at (8,0) {$20$};
            \node[anchor=north] at (9,0) {$25$};
            \node[anchor=north] at (10,0) {$30$};
            \node[anchor=north] at (11,0) {$35$};
            \node[anchor=north] at (12,0) {$40$};
            ...
            \filldraw
                (6.334,3) circle (2pt) node[align=center, above] {STS 51-C}
                (6.78,1) circle (2pt) node[align=center, above] {41B}
                (6.88,1) circle (2pt) node[align=center, below] {61C};
        \end{tikzpicture}
