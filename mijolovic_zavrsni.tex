...
\begin{document}
    ...
    \chapter{Osnovni statistički pokazatelji signala i vremenski nizovi}
        ...
        U daljnjim razmatranjima teme ovoga rada, a prateći generalni koncenzus u nomenklaturi stručnih izvora, pod analizom vremenskih nizova smatrati ćemo principe i modele koji analiziraju promatrane vrijednosti nasumičnih procesa -- koje ćemo detaljnije opisati u potpoglavlju \textit{\ref{stoh_proc}}.

        \subsection{Primjeri vremenskih nizova u elektrotehnici}
            %Priestley
