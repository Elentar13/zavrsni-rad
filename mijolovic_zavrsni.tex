    ...
    \chapter{Uvod}
        ...
        \begin{figure}[b]
            ...
            \begin{tikzpicture}
                ...
                \draw[-] (0,0) -- (0,3) node[pos=0.5, rotate=90, align=center, label={[rotate=90, left=1cm]center:Učestalost kvarova}, label position=above] {};
            ...
            \end{tikzpicture}
            \caption{Neki opisni tekst} \label{fig:M1}
        \end{figure}
