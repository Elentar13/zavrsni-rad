...
\begin{document}
    ...
    \chapter{Osnovni statistički pokazatelji signala i vremenski nizovi}
        ...
        Kroz sveučilišne studije elektrotehnike, primat kroz više godine studija drži spektralna analiza signala, kojom se nastoji opisati frenkvencijske karakteristike promatranog iznalog signala (poput amplitudno-frenkvencijske karakteristike, fazno-frekvencijske karakteristike ili pojačanja sustava) Navedeno se najčešće realizira kroz određivanje prijenostnih i inih funkcija stustava koje su od značaja za ponašanje elektroničkih sustava čija su baza elektroničke komponente čije karakteristike nisu nužno konstantne pri određenim frekvencijskim pojasevima -- što omogućuje korištenje određenih elektroničkih sustava u svrhu niskopropusnoga ili visokopropusnoga filtriranja, te propusnoga filtriranja određenog frekvencijskog opsega.
        ...
        \section{Osnovni statistički pokazatelji}
            ...
            \textbf{(stacionarni procesi, varijanca, kovarijanca,...)}

        \section{Vremenski nizovi}
            \textbf{(Doslovno sve o tome iz Priestlya i Petrusa)}     
