...
\begin{document}
    ...
    \chapter{Autoregresivni modeli}
        ...
        \section{Autoregresijski model (AR)}
            ...
            Autoregresijski $AR(p)$ model je reprezentacija nasumičnog procesa čija izlazna vrijednost u trenutku $x_t$ linearno ovisi o vlastitim prethodnim vrijednostima $x_{t-p}$. Navedeno načelo možemo matematički definirati kao
            ...
            \begin{table}[H]
                \centering
                \begin{tabular*}{0.9\textwidth}{>{\bfseries}l p{13cm}}
                    \textit{\textbf{$\boldsymbol{x_t}$}} & \textit{vrijednost funkcije u vremenu \textbf{t}}\\
                    \textit{\textbf{$\boldsymbol{\mu_x}$}} & \textit{srednja vrijednost funkcije}\\
