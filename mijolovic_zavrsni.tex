...
\begin{document}
    ...
    \chapter{Uvod}
        ...
        \begin{tikzpicture}
            \draw[very thin, color=gray] (12,3) grid (0,0);
            \draw[-] (0,0) -- (12,0) node[below] {$t/\textit{\textdegree C}$};
            \draw[-] (0,0) -- (0,3) node[left, align=center, text width=3cm] {Učestalost zakazivanja};
            \filldraw
                (1.25,0) circle (2pt) node[align=center, below] {61C};
        \end{tikzpicture}
