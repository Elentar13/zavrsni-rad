...
\newcommand{\nasavjerojatnost}{p(t)= \frac{e^{5.085-0.1156\cdot t}}{1+e^{5.085-0.1156\cdot t}}}
...
\begin{document}
    ...
    \chapter{Uvod}
        ...
        Prikazani model na slici \ref{fig:M2} reprezentira vjerojatnost kvara $p(t)$ pojedine brtve u ovisnosti o temperaturi spojišta prilikom lansiranja.
        ...
        \begin{figure}[H]
            ...
            \begin{tikzpicture}
                ...
                data[format=function]   {
                    ...
                    func y = divide(exp(5.085-0.1156*\value x),(1+exp(5.085-0.1156*\value x)));
                    %potrebno je modificirati formulu iz knjige budući da se ona odnosi na temperature u farenheitima - naći parametre a i b prema metodi "maximum likelihood" (page 319)
                };
            \end{tikzpicture}
            \caption{Podnaslov grafa}
            \label{fig:M2}
        \end{figure}
