...
\begin{document}
    ...
    \chapter{Osnovni pojmovi teorije vjerojatnosti i statistike pri obradi signala}
        ...
        \section{Stohastički procesi} \label{stoh_proc}
            ...
            % Jedan od najjednostavnijih je Simple Random Walk. Markovljev lanac - stohastički procesi čiji je utjecaj prošlih događaja na buduće događaje opisan samo trenutnim stanjem (važna samo zadnja vrijednost, sve korelacije su zapisane u toj jednoj vrijednosti...npr. to je simple random walk).
        ...
        \subsection{Vremenski nizovi}
            ...
            \footnotetext[1]{Dugoročna tendencija razvoja pojave u vremenu; Niz vrijednosti kroz koje bi promatrana pojava prolazila da nije bilo sezonskih ili slučajnih činbenika (vremenska razdoblja duža od 5 godina).}
