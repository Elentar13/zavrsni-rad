...
\begin{document}
    ...
    \chapter{Osnovni pojmovi teorije vjerojatnosti i statistike pri obradi signala}
        ...
        \section{Slučajni događaj}
            ...
            \textbf{Navesti primjere za različite presjeke skupova kada se očita neka vrijednost maksimalne struje u odnosu na sve moguće vrijednosti koje ta struja teoretski može zauzeti. Na temelju primjera datuma u Dekkingu}

            \subsection{Vjerojatnost slučajnih događaja}
